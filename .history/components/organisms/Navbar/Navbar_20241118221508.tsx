...
export const Navbar = () => {
  ...
  return (
    <FlowbiteNavbar
      ...
      style={{
        backgroundColor: "rgba(60, 179, 113, 0.9)", // Vert moyen
        borderBottom: "2px solid rgba(139, 69, 19, 0.5)", // Bordure marron clair
      }}
    >
      <Logo />
            ...
            <FlowbiteNavbar.Link as={Link} href={page.link} key={page.name}>
              <Typography
                ...
                style={{
                  ...
                  transition: "color 0.3s", // Ajout d'une transition pour le survol
                }}
              >
                {page.name}
              </Typography>
